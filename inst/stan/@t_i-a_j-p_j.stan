//
//   A t-a_j-p_j model with t_ provided as constants and p_j and a_j for each rater
//
...
data {
  ...
  array[N] real t; // the estimated true class probability for the ith rating
